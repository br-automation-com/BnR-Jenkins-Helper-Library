def call(Map config = [:]) {
    ...
    powershell(script: "E:/BrAutomation/AS410/Bin-en/BR.AS.Build.exe \"E:/workspace/mapp_Framework_develop_2/BaseProject/mappFramework/mappFramework.apj\" -buildMode \"Build\" -c ${config.configuration} -t C:/Temp/Simulation -o C:/Temp/Binaries/Simulation");
